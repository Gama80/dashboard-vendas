...
# === Novo link da planilha Google em .xlsx ===
url = "https://docs.google.com/spreadsheets/d/1J3lFWXmuE2nY0vNbMGff37rvSTCN7Db3/export?format=xlsx"

# Leitura do Excel diretamente da URL
...
# === KPIs ===
st.title("Painel de Vendas (.xlsx Google Sheets + Streamlit)")
...
st.plotly_chart(px.bar(vendedores, x='VENDEDOR', y='PRECOVENDA'))
...
st.plotly_chart(px.bar(meses, x='AnoMes', y='PRECOVENDA'))
